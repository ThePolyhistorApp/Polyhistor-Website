...
export const faqData: FaqItem[] = [
  {
    question: "When is PolyHistor launching?",
    answer:
  ...
  },
  {
    ...
    answer:
      "PolyHistor will operate on a freemium model. Core features like live location sharing will be free for everyone. Advanced AI-powered features, including our proactive safety alerts and intelligent trip planner, will be part of a premium subscription.",
  },
  {
    question: "What devices will be supported?",
    answer:
      "We are building PolyHistor as a mobile-first application and will be launching on both iOS and Android simultaneously.",
  },
  {
